 ...
 * lines of interest.
 */
__no_kcsan static void
probe_console(void *ignore, const char *buf, size_t len)
{
    unsigned long flags;
    int nlines;
...
__no_kcsan static bool
report_available(void)
{
...
__no_kcsan static bool
__report_matches(const struct expect_report *r)
{
    ...
    for (i = 0; i < 2; ++i) {
        ...
        const char *const access_type =
            (ty & KCSAN_ACCESS_ASSERT) ? ((ty & KCSAN_ACCESS_WRITE) ? "assert no accesses" : "assert no writes") : ((ty & KCSAN_ACCESS_WRITE) ? ((ty & KCSAN_ACCESS_COMPOUND) ? "read-write" : "write") : "read");
...
__no_kcsan static bool
report_matches_any_reordered(struct expect_report *r)
{
 ...
 * for writes.
 */
__no_kcsan static noinline void
sink_value(long v)
{
    WRITE_ONCE(test_sink, v);
}
...
static noinline void
test_kernel_read(void)
{
    sink_value(test_var);
}

static noinline void
test_kernel_write(void)
{
    test_var = READ_ONCE_NOCHECK(test_sink) + 1;
}

static noinline void
test_kernel_write_nochange(void)
{
    test_var = 42;
}
...
static noinline void
test_kernel_write_nochange_rcu(void)
{
    test_var = 42;
}

static noinline void
test_kernel_read_atomic(void)
{
    sink_value(READ_ONCE(test_var));
}

static noinline void
test_kernel_write_atomic(void)
{
    WRITE_ONCE(test_var, READ_ONCE_NOCHECK(test_sink) + 1);
}

static noinline void
test_kernel_atomic_rmw(void)
{
...
__no_kcsan static noinline void
test_kernel_write_uninstrumented(void)
{
    test_var++;
}

static noinline void
test_kernel_data_race(void)
{
    data_race(test_var++);
}

static noinline void
test_kernel_assert_writer(void)
{
    ASSERT_EXCLUSIVE_WRITER(test_var);
}

static noinline void
test_kernel_assert_access(void)
{
...
static noinline void
test_kernel_assert_bits_change(void)
{
    ASSERT_EXCLUSIVE_BITS(test_var, TEST_CHANGE_BITS);
}

static noinline void
test_kernel_assert_bits_nochange(void)
{
    ASSERT_EXCLUSIVE_BITS(test_var, ~TEST_CHANGE_BITS);
}
...
static noinline void
test_kernel_assert_writer_scoped(void)
{
...
static noinline void
test_kernel_assert_access_scoped(void)
{
...
static noinline void
test_kernel_write_struct_part(void)
{
...
static noinline void
test_kernel_jiffies_reader(void)
{
    sink_value((long) jiffies);
}

static noinline void
test_kernel_seqlock_reader(void)
{
    unsigned int seq;
...
static noinline void
test_kernel_seqlock_writer(void)
{
    unsigned long flags;
...
static noinline void
test_kernel_atomic_builtins(void)
{
    /*
 ...
 */
static void
test_barrier_nothreads(struct kunit *test)
{
#ifdef CONFIG_KCSAN_WEAK_MEMORY
 ...
 */
__no_kcsan static void
test_concurrent_races(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
...
__no_kcsan static void
test_novalue_change(struct kunit *test)
{
 ...
 */
__no_kcsan static void
test_novalue_change_exception(struct kunit *test)
{
    struct expect_report expect_rw = {
        .access = {
...
__no_kcsan static void
test_unknown_origin(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
            {test_kernel_read, &test_var, sizeof(test_var), 0},
...
__no_kcsan static void
test_write_write_assume_atomic(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
            {test_kernel_write, &test_var, sizeof(test_var), KCSAN_ACCESS_WRITE},
 ...
 */
__no_kcsan static void
test_write_write_struct(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
 ...
 */
__no_kcsan static void
test_write_write_struct_part(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
            {test_kernel_write_struct, &test_struct, sizeof(test_struct), KCSAN_ACCESS_WRITE},
...
__no_kcsan static void
test_read_atomic_write_atomic(struct kunit *test)
{
    bool match_never = false;
...
__no_kcsan static void
test_read_plain_atomic_write(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
            {test_kernel_read, &test_var, sizeof(test_var), 0},
...
__no_kcsan static void
test_read_plain_atomic_rmw(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
            {test_kernel_read, &test_var, sizeof(test_var), 0},
...
__no_kcsan static void
test_zero_size_access(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
            {test_kernel_write_struct, &test_struct, sizeof(test_struct), KCSAN_ACCESS_WRITE},
...
__no_kcsan static void
test_data_race(struct kunit *test)
{
    bool match_never = false;
...
__no_kcsan static void
test_assert_exclusive_writer(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
...
__no_kcsan static void
test_assert_exclusive_access(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
...
__no_kcsan static void
test_assert_exclusive_access_writer(struct kunit *test)
{
...
__no_kcsan static void
test_assert_exclusive_bits_change(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
...
__no_kcsan static void
test_assert_exclusive_bits_nochange(struct kunit *test)
{
    bool match_never = false;
...
__no_kcsan static void
test_assert_exclusive_writer_scoped(struct kunit *test)
{
...
__no_kcsan static void
test_assert_exclusive_access_scoped(struct kunit *test)
{
 ...
 */
__no_kcsan static void
test_jiffies_noreport(struct kunit *test)
{
    bool match_never = false;
...
__no_kcsan static void
test_seqlock_noreport(struct kunit *test)
{
    bool match_never = false;
 ...
 */
static void
test_atomic_builtins(struct kunit *test)
{
    bool match_never = false;
...
__no_kcsan static void
test_1bit_value_change(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
            {test_kernel_read, &test_var, sizeof(test_var), 0},
...
__no_kcsan static void
test_correct_barrier(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
...
__no_kcsan static void
test_missing_barrier(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
...
__no_kcsan static void
test_atomic_builtins_correct_barrier(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
...
__no_kcsan static void
test_atomic_builtins_missing_barrier(struct kunit *test)
{
    struct expect_report expect = {
        .access = {
 ...
 */
static const void *
nthreads_gen_params(const void *prev, char *desc)
{
...
__no_kcsan static void
access_thread_timer(struct timer_list *timer)
{
...
__no_kcsan static int
access_thread(void *arg)
{
...
__no_kcsan static void
register_tracepoints(struct tracepoint *tp, void *ignore)
{
...
__no_kcsan static void
unregister_tracepoints(struct tracepoint *tp, void *ignore)
{
    if (!strcmp(tp->name, "console"))
...
static int
kcsan_suite_init(struct kunit_suite *suite)
{
    /*
...
static void
kcsan_suite_exit(struct kunit_suite *suite)
{
